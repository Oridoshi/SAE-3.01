 ...
 * PageEditionModule
 */
public class PageEditionSae extends JPanel implements ActionListener, FocusListener
{
	...
	private JIntegerTextField txtFNbHSaeSem;
	private JIntegerTextField txtFNbHTutSem;
	private JIntegerTextField txtFTotHSaeAff;
	private JIntegerTextField txtFTotHTutAff;
	private JIntegerTextField txtFSom1;
	private JIntegerTextField txtFTotSom2;

	public static PageEditionSae factorieCreationSae(Controleur ctrl, FrameIhm mere, Semestre semestre)
	{
		PageEditionSae page = new PageEditionSae(ctrl, mere, semestre, new Module("SX.XX", semestre, ctrl.getCategorieModule("SAE"), false, "", ""), null);
		return page;
	}

	public static PageEditionSae factorieEditionSae(Controleur ctrl, FrameIhm mere, Module module)
	{
		PageEditionSae page = new PageEditionSae(ctrl, mere, module.getSemestre(), module, module.getLstAffectation());
		return page;
	}

	private PageEditionSae(Controleur ctrl, FrameIhm mere, Semestre semestre, Module module, List<Affectation> lstAffectation)
	{
		this.ctrl = ctrl;
		this.mere = mere;
		this.MODULE = module;
		...
		lblTyMo.setForeground(PageEditionSae.COULEUR_LABEL);
		lblTyMo.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblSeme = new JLabel("Semestre");
		lblSeme.setForeground(PageEditionSae.COULEUR_LABEL);
		lblSeme.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblCode = new JLabel("Code");
		lblCode.setForeground(PageEditionSae.COULEUR_LABEL);
		lblCode.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblLibelLong = new JLabel("Libellé Long");
		lblLibelLong.setForeground(PageEditionSae.COULEUR_LABEL);
		lblLibelLong.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblLibelCour = new JLabel("Libellé Court");
		lblLibelCour.setForeground(PageEditionSae.COULEUR_LABEL);
		lblLibelCour.setFont(PageEditionSae.FONT_LABEL);
		...
		lblNbEtd.setForeground(PageEditionSae.COULEUR_LABEL);
		lblNbEtd.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblNbGrpTd = new JLabel("Nb Grp TD");
		lblNbGrpTd.setForeground(PageEditionSae.COULEUR_LABEL);
		lblNbGrpTd.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblNbGrpTp = new JLabel("Nb Grp TP");
		lblNbGrpTp.setForeground(PageEditionSae.COULEUR_LABEL);
		lblNbGrpTp.setFont(PageEditionSae.FONT_LABEL);
		...
		JLabel lblHProHSae = new JLabel("H SAE");
		lblHProHSae.setForeground(PageEditionSae.COULEUR_LABEL);
		lblHProHSae.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblHProHTut = new JLabel("H Tut");
		lblHProHTut.setForeground(PageEditionSae.COULEUR_LABEL);
		lblHProHTut.setFont(PageEditionSae.FONT_LABEL);

		gbcTemp.gridy = 0;
		gbcTemp.gridx = 1;
		panelTemp.add(lblHProHSae, gbcTemp);
		gbcTemp.gridx = 2;
		panelTemp.add(lblHProHTut, gbcTemp);

		//deuxieme ligne
		gbcTemp.insets = new Insets(0, 1, 1, 0); // Marge autour des composants

		this.txtFHProHSae = new JIntegerTextField(3, module.getNbHeureProgramme("HSAE"));
		this.txtFHProHSae.setAllowsInvalid(false);
		this.txtFHProHSae.addFocusListener(this);
		this.txtFHProHSae.addActionListener(this);
		...
		gbcTemp.gridy = 1;
		gbcTemp.gridx = 1;
		panelTemp.add(this.txtFHProHSae, gbcTemp);
		gbcTemp.gridx = 2;
		...
		lblTotal.setForeground(PageEditionSae.COULEUR_LABEL);
		lblTotal.setFont(PageEditionSae.FONT_LABEL);

		this.txtFTotEqTdHProSae = new JIntegerTextField(3);
		this.txtFTotEqTdHProSae.setEditable(false);
		this.txtFTotEqTdHProSae.setValue((int) (this.txtFHProHSae.getValue() * this.ctrl.getCoefH("HSAE")));
		...
		gbcTemp.gridx = 1;
		panelTemp.add(this.txtFTotEqTdHProSae, gbcTemp);
		gbcTemp.gridx = 2;
		...
		lblPromo.setForeground(PageEditionSae.COULEUR_LABEL);
		lblPromo.setFont(PageEditionSae.FONT_LABEL);
		...
		lblHProSomme.setForeground(PageEditionSae.COULEUR_LABEL);
		lblHProSomme.setFont(PageEditionSae.FONT_LABEL);
		...
		this.txtFHProSomme.setValue(this.txtFHProHSae.getValue() + this.txtFHProHTut.getValue());
		...
		this.txtFTotEqTdHProSomme.setValue(this.txtFTotEqTdHProSae.getValue() + this.txtFTotEqTdHProTut.getValue());
		...
		labelEspace.setForeground(PageEditionSae.COULEUR_LABEL);
		labelEspace.setFont(PageEditionSae.FONT_LABEL);
		...
		lblValider.setForeground(PageEditionSae.COULEUR_LABEL);
		lblValider.setFont(PageEditionSae.FONT_LABEL);
		...
		lblPnLocal.setForeground(PageEditionSae.COULEUR_LABEL);
		lblPnLocal.setFont(PageEditionSae.FONT_LABEL);
		...
		JLabel lblNbHSae = new JLabel("H SAE");
		lblNbHSae.setForeground(PageEditionSae.COULEUR_LABEL);
		lblNbHSae.setFont(PageEditionSae.FONT_LABEL);
		JLabel lblNbHSem1 = new JLabel("H Tut");
		lblNbHSem1.setForeground(PageEditionSae.COULEUR_LABEL);
		lblNbHSem1.setFont(PageEditionSae.FONT_LABEL);

		gbcRepartition.gridy = 1;
		gbcRepartition.gridx = 1;
		panelTmpRepartition.add(lblNbHSae, gbcRepartition);
		...
		lblTotPromo.setForeground(PageEditionSae.COULEUR_LABEL);
		lblTotPromo.setFont(PageEditionSae.FONT_LABEL);

		this.txtFNbHSaeSem = new JIntegerTextField(3, module.getNbHeureSemaine("HSAE"));
		this.txtFNbHSaeSem.setAllowsInvalid(false);
		this.txtFNbHSaeSem.addFocusListener(this);
		this.txtFNbHSaeSem.addActionListener(this);
		...
		gbcRepartition.gridx = 1;
		panelTmpRepartition.add(this.txtFNbHSaeSem, gbcRepartition);
		gbcRepartition.gridx = 2;
		...
		lblTotAff.setForeground(PageEditionSae.COULEUR_LABEL);
		lblTotAff.setFont(PageEditionSae.FONT_LABEL);

		this.recalculeTotalAffecte();

		this.txtFTotHSaeAff = new JIntegerTextField(3, this.nbTotAffHSae);
		this.txtFTotHSaeAff.setEditable(false);
		...
		gbcRepartition.gridx = 1;
		panelTmpRepartition.add(this.txtFTotHSaeAff, gbcRepartition);
		gbcRepartition.gridx = 2;
		...
		lblSommeSem.setForeground(PageEditionSae.COULEUR_LABEL);
		lblSommeSem.setFont(PageEditionSae.FONT_LABEL);
		...
		this.txtFSom1.setValue(this.txtFNbHSaeSem.getValue() + this.txtFNbHTutSem.getValue());
		...
		this.txtFTotSom2.setValue(this.txtFTotHSaeAff.getValue() + txtFTotHTutAff.getValue());
		...
		lblListeAffectation.setForeground(PageEditionSae.COULEUR_LABEL);
		lblListeAffectation.setFont(PageEditionSae.FONT_LABEL);
		...
		lblRepartition.setForeground(PageEditionSae.COULEUR_LABEL);
		lblRepartition.setFont(PageEditionSae.FONT_LABEL);
	...
	public void focusLost(FocusEvent e)
	{
		...
		{
			String regex = "^S[1-6]\\.\\d{2}$";
			Pattern pattern = Pattern.compile(regex);
			Matcher matcher = pattern.matcher(this.txtFCode.getText());
			if(matcher.matches())
			{
				regex   = "^S[" + this.MODULE.getSemestre().getId() + "]\\.\\d{2}$";
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			if(this.txtFCode.getText().equals("SX.XX"))
			{
	...
	private boolean valeurEntreOk(boolean selected)
	{
		...
		else
		{
			...
			else if(this.txtFHProHSae.getValue() > this.txtFNbHSaeSem.getValue()) 
			{
	...
	private void majModule()
	{
		...
		this.MODULE.getProgramme().getItem("HSAE").setNbHPn(this.txtFHProHSae.getValue());
		this.MODULE.getProgramme().getItem("HT").setNbHPn(this.txtFHProHTut.getValue());
		this.MODULE.getProgramme().getItem("HSAE").setNbHeure(this.txtFNbHSaeSem.getValue());
	...
	private void recalcule()
	{
		...
		this.recalculeTotalAffecte();
		this.txtFTotHSaeAff.setValue(this.nbTotAffHSae);
		this.txtFTotHTutAff.setValue(this.nbTotAffHTut);
		this.txtFSom1.setValue(this.txtFNbHSaeSem.getValue() + this.txtFNbHTutSem.getValue());
		this.txtFTotSom2.setValue(this.txtFTotHSaeAff.getValue() + this.txtFTotHTutAff.getValue());
