 ...
 */
public class ModelAffichageIntervenant extends AbstractTableModel
{
	private Controleur ctrl;

	private Object[][] tabDonnees;

	public ModelAffichageIntervenant(Controleur ctrl, ArrayList<ModuleResource> lstRessource)
	{
		this.ctrl = ctrl;
